...
class Interseccion:
    ...
    def __init__(self, sc):
        ...
        self.maxVhCarrilesEntrada = {}  # La cantidad máxima de vehículos vista en ese carril de entrada
        self.maxVhCarrilesSalida = {}   # La cantidad máxima de vehículos vista en ese carril de salida
        ...
        for sg in sc.SGs:
            idSignalGroup = sg.AttValue('Name')
            print "\n  ++ Generando Cruce para SignalGroup "+idSignalGroup
            carrilEntrada, carrilesSalida = idSignalGroup.split(';')[0],idSignalGroup.split(';')[1].split(':')
            ...
            self.cruces[idSignalGroup] = [sg,carrilEntrada,carrilesSalida]
